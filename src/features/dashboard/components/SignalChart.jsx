...
/**
 * Converts a date-time string to the chart's required date format.
...
/**
 * Renders a signal chart displaying trading signals on price data.
 * Utilizes the lightweight-charts library for rendering.
 *
 * @param {{ price_data: Array<{timestamp: string, symbol: string, close: number}>, signals_data: Array<{timestamp: string, trade_instructions: Array<{ticker: string, direction: string}>}> }} props - Component props.
 */
